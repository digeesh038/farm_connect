...
<body>
     ...
     <body>
          ...
          <div class="row" style="text-align:center;">
               ...
               <div class="col-md-3 col-sm-12">
                    <a href="../equipment-rental/index.php" id="navbar"><i class="fa fa-leaf" aria-hidden="true"></i><label>Equipments</label></a>
               </div>
               <div class="col-md-3 col-sm-12">
          ...
          <div class=content_item>
               ...
               if (isset($_SESSION['phonenumber'])) {
                    ...
                    <button class='btn btn-warning btn-lg p-3 m-3 font-weight-bold'>Add New Product <i class='fa fa-plus-square p-2 fa-1x'></i>
                    </button>
                    </a>";
               } else {
